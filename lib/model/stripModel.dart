...
//
//     final strip = stripFromJson(jsonString);

import 'dart:convert';

Strip stripFromJson(String str) => Strip.fromJson(json.decode(str));

String stripToJson(Strip data) => json.encode(data.toJson());
...
class Strip {
  ...
  factory Strip.fromJson(Map<String, dynamic> json) => Strip(
